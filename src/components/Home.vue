    ...
    <div class="row">
        <div class="col-md-3" v-for="result in results" :key="result.idMeal" style="text-align: center;">
          ...
          <div class="card" style="width: 15rem; height: 90%;">
            ...
            <b-button variant="primary"  style="text-align: center" @click="addFav(result.idMeal,result.strMealThumb,result.strMeal,result.strCategory)"><b-icon icon="star" /> Add Favorite</b-button>
          </div>
          </router-link>`
        </div>
    </div>
